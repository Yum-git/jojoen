...
tmp_light_rhythm3 = [3 / 16, 1 / 16, 3 / 16, 1 / 16, 3 / 16, 1 / 16, 3 / 16, 1 / 16, 3 / 16, 1 / 16, 3 / 16, 1 / 16,
                     1 / 16]
...
class makeRhythm(object):
    def __init__(self, posinega_score: int, musicalScore: list):
        self.posinega_score = posinega_score
